...
void render(const std::function<void()>& scene) {
    ...
    style.Colors[ImGuiCol_WindowBg] = ImVec4(0.1015625f, 0.1015625f, 0.1015625f, 1.0f); // Dark gray
    style.Colors[ImGuiCol_ChildBg] = ImVec4(0.1015625f, 0.1015625f, 0.1015625f, 1.0f); // Dark gray
    ...
    // Our states
	// clear_color - The background color of the whole window
